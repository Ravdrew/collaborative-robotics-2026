...
# test_planner_sim.py.
# ---------------------------------------------------------------------------
_FINGERS_DOWN_VERTICAL_QW = 0.5
_FINGERS_DOWN_VERTICAL_QX = 0.5
_FINGERS_DOWN_VERTICAL_QY = 0.5
_FINGERS_DOWN_VERTICAL_QZ = -0.5
_FINGERS_DOWN_HORIZONTAL_QW = 0.707107
_FINGERS_DOWN_HORIZONTAL_QX = 0.0
_FINGERS_DOWN_HORIZONTAL_QY = 0.707107
_FINGERS_DOWN_HORIZONTAL_QZ = 0.0
